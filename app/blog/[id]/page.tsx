...
const blogPosts = [
  {
    ...
    pdfUrl: `${nextConfig.basePath}/blog/efficient-variational-sequential-information-control.pdf`,
  ...
  },
  {
    ...
    pdfUrl: `${nextConfig.basePath}/blog/privacy-preserving-tree-ensembles.pdf`,
  ...
  },
  {
    ...
    pdfUrl: `${nextConfig.basePath}/blog/high-performance-logistic-regression.pdf`,
  ...
  },
  {
    ...
    pdfUrl: `${nextConfig.basePath}/blog/interactive-map-gps-traces.pdf`,
  ...
  },
  {
    ...
    pdfUrl: `${nextConfig.basePath}/blog/map-vs-gps-trace.pdf`,
    authors: ['A Hendawi', 'SS Sabbineni', 'Jianwei Shen', 'Y Song', 'P Cao', 'Z Zhang', 'J Krumm', 'et al.'],
