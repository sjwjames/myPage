...
const blogPosts = [
  {
    ...
    pdfUrl: '/myPage/blog/efficient-variational-sequential-information-control.pdf',
  ...
  },
  {
    ...
    pdfUrl: '/myPage/blog/privacy-preserving-tree-ensembles.pdf',
  ...
  },
  {
    ...
    pdfUrl: '/myPage/blog/high-performance-logistic-regression.pdf',
  ...
  },
  {
    ...
    pdfUrl: '/myPage/blog/interactive-map-gps-traces.pdf',
  ...
  },
  {
    ...
    pdfUrl: '/myPage/blog/map-vs-gps-trace.pdf',
    authors: ['A Hendawi', 'SS Sabbineni', 'Jianwei Shen', 'Y Song', 'P Cao', 'Z Zhang', 'J Krumm', 'et al.'],
